const styles = {
    ...
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#8E376A]",
    button: 'w-[150px] hover:bg-[#c79bb5] hover:bg-[#ffffff] bg-[#8E376A] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#8E376A] flex items-center justify-center cursor-pointer",
    cart_button_text:"text-[#fff] text-[16px] font-[600]",
    input:"w-full border p-1 rounded-[5px]",
    activeStatus:"w-[10px] h-[10px] rounded-full absolute top-0 right-1 bg-[#8E376A]",
